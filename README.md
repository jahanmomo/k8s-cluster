...
sudo apt-get update  # Corrected command: "sudo apt get update" to "sudo apt update"
sudo apt-get -y install containerd

sudo apt-get -y install containerd
sudo containerd config default | sudo tee /etc/containerd/config.toml  # Corrected command to use a pipe instead of redirection
...
sudo systemctl daemon-reload  # Corrected command: "sudo systemctl daemon-relad" to "sudo systemctl daemon-reload"
...
kubectl exec -n kube-system weave-net-hxvcj -c weave -- /home/weave/weave --local status
